...
const SheetOverlay = Dialog.Overlay
...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <SheetOverlay
        className={cn(
          "fixed inset-0 z-50 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out data-[state=closed]:duration-300 data-[state=open]:duration-500"
        )}
      />
      <Dialog.Content
        className={cn(
