Oorspronkelijk: archive/v3/adr-003-llm-import-openai-celery.md
...
1. **LLM-provider en model:** OpenAI **GPT-4o-mini**, met **Structured Outputs** (JSON schema) voor voorspelbare response-vorm. Voldoende kwaliteit voor Nederlandse werkwoorden en korte zinnen; lage kosten; ondersteuning voor strict JSON output.
