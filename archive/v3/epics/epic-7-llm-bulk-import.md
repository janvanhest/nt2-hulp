...
Bouwt voort op Epic 0 (Foundation), Epic 1 (Rollen & autorisatie), **Epic 2 (Werkwoorden Beheren)** en **Epic 3 (Invulzinnen Beheren)**. Zie [v3/epics.md](../v3/epics.md).
...
| Seed/import bestaande data | Ja | Uit [v3/epics.md](../v3/epics.md); kan naast LLM-import worden uitgewerkt. |
| Handmatig één werkwoord LLM-zinnen | Nee | Epic 7 focust op bulk; enkelvoudige "genereer zinnen" voor één werkwoord kan later. |

### Acceptatiecriteria (uit en uitgebreid t.o.v. `v3/epics.md`)
...
3. Eventuele AI-ondersteuning is beperkt tot eenmalig invullen van ontbrekende data; resultaten worden opgeslagen en hergebruikt (randvoorwaarde uit `v3/casus.md`).
...
- **Epic 7 in epics:** [v3/epics.md](../v3/epics.md) (Data Import/Seed en "AI als invoerhulp").
- **ADR (OpenAI, Celery, twee calls):** [v3/adr-003-llm-import-openai-celery.md](../v3/adr-003-llm-import-openai-celery.md).
- **Datamodel (Job, Item):** [docs/epic-7-datamodel-import.md](epic-7-datamodel-import.md).
- **LLM-contracten (request/response A en B):** [docs/epic-7-llm-contracts.md](epic-7-llm-contracts.md).
- **Validatieregels:** [docs/epic-7-validatie.md](epic-7-validatie.md).
- **Technisch overzicht (flow, componenten):** [docs/epic-7-technisch-overzicht.md](epic-7-technisch-overzicht.md).
- **Admin UX (formulier, job-detail):** [docs/epic-7-admin-ux.md](epic-7-admin-ux.md).
- **Bestaande modellen en ERD:** [v3/erd.md](../v3/erd.md), [backend/verbs/models.py](../backend/verbs/models.py).
