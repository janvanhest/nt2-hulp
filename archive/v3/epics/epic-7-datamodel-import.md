...
Bestaande modellen en ERD: [v3/erd.md](../v3/erd.md), [backend/verbs/models.py](../backend/verbs/models.py) (Verb, VerbForm, FillInSentence).
...
De volgende entiteiten komen bij het bestaande [v3/erd.md](../v3/erd.md) (concept) voor Epic 7:
...
- [v3/erd.md](../v3/erd.md) — bestaand ERD (WERKWOORD, WERKWOORDSVORM, INVULZIN).
- [backend/verbs/models.py](../backend/verbs/models.py) — Verb, VerbForm, FillInSentence, VdHulp, AnswerFormKey.
- [docs/epic-7-llm-bulk-import.md](epic-7-llm-bulk-import.md) — overzicht Epic 7.
