...
- [docs/epic-7-llm-contracts.md](epic-7-llm-contracts.md) — response-structuur product A en B.
- [docs/epic-7-datamodel-import.md](epic-7-datamodel-import.md) — VerbImportItem.status, error_message, raw_response.
